...
$execute if items block $(x) $(y) $(z) container.* potion run advancement grant @s only all_tasks:tasks/structures/ancient_city/loot_normal/loot potion_of_regeneration
$execute if items block $(x) $(y) $(z) container.* enchanted_book[!stored_enchantments~[{enchantments:"swift_sneak"}]] run advancement grant @s only all_tasks:tasks/structures/ancient_city/loot_normal/loot enchanted_book
...
$execute if items block $(x) $(y) $(z) container.* enchanted_book[stored_enchantments~[{enchantments:"swift_sneak"}]] run advancement grant @s only all_tasks:tasks/structures/ancient_city/loot_normal/loot enchanted_book_swift_sneak
